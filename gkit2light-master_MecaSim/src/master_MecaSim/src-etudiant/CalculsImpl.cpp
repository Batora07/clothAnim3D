 ...
 */
void SolveurImpl::Remplissage_Y(unsigned int nb_som,
                std::vector<Vector>& V,
                std::vector<Vector>& Force,
                std::vector<float>& M,
                Vector g,
 ...
 */
void SolveurImpl::CalculProdMatVect(unsigned int nb_som,
                  std::vector<float>& M,
                  MSS* _SytemeMasseRessort) {
  ////////
 ...
 */
void SolveurImpl::CalculDirection(unsigned int nb_som) {
 ...
 */
void SolveurImpl::CalculSolution_Residu(unsigned int nb_som) {
 ...
 */
void SolveurImpl::CalculBeta(unsigned int nb_som) {
 ...
 */
void SolveurImpl::CalculNorme(unsigned int nb_som) {
 ...
 * Y = dt f(t) + dt^2 df/dx v(t)
 */
void SolveurImpl::Resolution(unsigned int nb_som,
               std::vector<float>& M,
               MSS* _SytemeMasseRessort) {
 ...
 * x(t+dt) = x(t) + dt v(t+h).
 */
void SolveurImpl::CalculPosition(unsigned int nb_som,
                 std::vector<Vector>& V,
                 std::vector<Vector>& P) {
